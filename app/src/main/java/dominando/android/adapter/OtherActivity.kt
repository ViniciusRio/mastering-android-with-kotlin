...
class OtherActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val clientParceler = Parcels.unwrap<ClientParceler?>(intent.getParcelableExtra<Client>("clientParcel"))
        ...
        tvMessage.text = if(client != null) {
            ...
            getString(R.string.text_two_other_activity, person?.name, person?.age)
                ...
                getString(R.string.text_one_other_activity, clientParceler.name,
                    clientParceler.code
                )
        } else {
